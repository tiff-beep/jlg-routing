...
export const INITIAL_AGENTS: Agent[] = [
  ...
  { id: "ian",      name: "Ian",      role: "agent",
    ...
    notes: "Super new (Mar '26). 45% appt kept, already closed 1 team lead. Listing training not yet scheduled.",
    active: true, onVacation: false, returnDate: null, provisional: false },
  ...
  { id: "rae",      name: "Rae",      role: "agent",
    ...
    conversionOverall: null, conversionListing: null,
    notes: "New (Oct '25). 47% appt kept. Watch cherry-picking. Listing training not yet scheduled.",
    active: true, onVacation: false, returnDate: null, provisional: false },
  ...
  { id: "casey",    name: "Casey",    role: "partner",
    ...
    active: true, onVacation: true, returnDate: null, provisional: false },
  ...
  { id: "lauren",   name: "Lauren",   role: "jr_partner",
    ...
    active: true, onVacation: true, returnDate: "2026-07-02", provisional: false },
  { id: "paige",    name: "Paige",    role: "agent",
    ...
    active: true, onVacation: true, returnDate: "2026-06-30", provisional: false },
  { id: "valerie",  name: "Valerie",  role: "agent",
    ...
    conversionOverall: null, conversionListing: null,
    notes: "Provisional (Apr '26). <$250k + rentals. Must meet 2 people face-to-face first.",
    active: true, onVacation: false, returnDate: null, provisional: true },
  { id: "darrell",  name: "Darrell",  role: "agent",
    ...
    devCommunities: [], buyerOnly: true, listingsOnly: false, takesRentals: true,
    conversionOverall: null, conversionListing: null,
    notes: "Provisional (Mar '26). <$250k + rentals. Must meet 2 people face-to-face first.",
    active: true, onVacation: false, returnDate: null, provisional: true },
  ...
  { id: "kami",     name: "Kami",     role: "agent",
    ...
    devCommunities: [], buyerOnly: true, listingsOnly: false, takesRentals: true,
    conversionOverall: null, conversionListing: null,
    notes: "Coming soon — will join under $250k rotation.",
    active: false, onVacation: false, returnDate: null, provisional: true, comingSoon: true },
